...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-navy-900">Add Online Class</h1>
            <p class="text-slate-500 text-sm">Schedule a new live session</p>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.online-classes.store') }}"
        ...
        <div>
            ...
            <input type="text" name="title" value="{{ old('title') }}"
                   ...
                   placeholder="e.g. ICT Grade 10 — Chapter 5 Revision">
        ...
        <div>
            ...
            <select name="grade_class_id" class="form-input w-full rounded-xl border-slate-200">
                ...
                <option value="{{ $gc->id }}" {{ old('grade_class_id') == $gc->id ? 'selected' : '' }}>
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                      class="form-input w-full rounded-xl border-slate-200"
                      placeholder="Topics covered, notes...">{{ old('description') }}</textarea>
        </div>
